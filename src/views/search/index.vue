<template>
  <div>
    <div class="searchBar">
      <div class="searchBox">
        <input name="searchtext" id="searchInput" v-model="searchWord" placeholder="输入你想要搜索的热词" autocomplete="off" @keydown.enter="onSearch"><a-icon class="searchIcon" type="search" @click="onSearch"/>
      </div>
    </div>
    <div class="dropdownBar">
      <a-cascader :options="options" :default-value="['1', '过去一天内']" :allowClear="false" placeholder="请选择时间段" @change="onChange" />
    </div>
    <div class="graphBox">
      <item-card>
